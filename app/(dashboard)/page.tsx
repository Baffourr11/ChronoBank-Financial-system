...
// Note: SpendingOverview and RecentTransactions components need to be created
...
export default function Dashboard() {
  ...
  useEffect(() => {
    // Don't fetch data if no dataset is selected
    if (!datasetId) {
      setIsLoading(false);
      return;
    }
    ...
    const fetchDashboardData = async () => {
      try {
        // Fetch basic statistics with dataset ID
        const [
          accountsResponse,
        ...
        // Fetch analytics data with dataset ID
              ...
              <AlertDescription>
                <div className="flex items-center justify-between">
                  <span>
                    ...
                    Currently have {stats.transactionCount} transactions, need
                    at least{" "}
                    {
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold">
                        GHS {stats.totalBalance.toFixed(0)}
                      </p>
                    </div>
                  </div>
                </CardContent>
            ...
            <TabsContent value="overview" className="space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-muted-foreground">
                      Spending overview component coming soon
                    </p>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Latest transactions from your dataset
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    Recent transactions component coming soon
                  </p>
                </CardContent>
              </Card>
            </TabsContent>
                  ...
                  {forecast.cashFlowIssues?.hasIssues && (
                    <Alert>
                      ...
                      <AlertDescription>
                        <div className="flex items-center justify-between">
                          <span>
                            {forecast.cashFlowIssues.issues.length} potential
                            cash flow issues detected in the next 90 days.
                          </span>
